...
with tab2:
    if st.session_state.roadmap:
        ...
        def generate_pdf():
            ...
            c.drawCentredString(width / 2, y_position, "SkillWise Learning Roadmap")
            y_position -= 0.5 * inch
            ...
            for line in st.session_state.roadmap.splitlines():
                ...
                if line.startswith("**"):
                    ...
                    c.drawString(inch, y_position, line[2:])
                    y_position -= 0.5 * inch
                elif line.startswith("*"):
                    c.setFont("Helvetica", 12)
                    c.drawString(inch + 0.2 * inch, y_position, f"- {line[1:]}")
                    y_position -= 0.3 * inch
                else:
                    c.setFont("Helvetica", 12)
            ...
            c.drawCentredString(width / 2, 0.5 * inch, "Generated by SkillWise")
